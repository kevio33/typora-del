...
public class typoradel {
    ...
    static void delAssets(String path, String picDir2) throws Exception {
        ...
        if (StringUtils.isNotBlank(path)) {
            ...
            if (!file.exists()) {
                ...
                if (StringUtils.isBlank(picDir)) {
                    picDir = StringUtils.substringBefore(file.getName(), ".") + ".assets";
                }
        ...
        while (matcher.find()) {
            ...
            for (String pict : picturesInDirectory) {
                String pic = directory.getAbsolutePath() + File.separator + picDir + File.separator + pict;
